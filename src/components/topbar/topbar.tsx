...
function Topbar() {
    ...
    return (
        <>
        <div className={`relative flex md:py-1 py-3 sticky top-0 left-0 w-full justify-between items-center bg-[#f8f8f8] dark:bg-black border-b border-gray-500/[0.1] z-[10] ${noheader.includes(pathname.split("/")[1]) ? "hidden": ""} ${accountPages.includes(pathname.split("/")[1]) ? "md:px-10 pl-6 pr-[80px] md:py-2 py-5" : "md:px-[8%] px-6"}`}>
