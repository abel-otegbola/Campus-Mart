    ...
    return (
        <div>
            ...
            <div className="relative flex md:px-[8%] py-[30px] items-stretch min-h-[100vh]">
                <div className={`h-full rounded md:sticky md:top-[120px] absolute top-0 left-0 bg-white dark:bg-black md:border-none border border-transparent border-x-gray-100 dark:border-x-gray-900 overflow-hidden transition-all duration-700
...

                    {
                        links.map(link => (
                            <a
                                key={link.id}
                                href={"#" + link.title} 
                                className={`flex py-3 px-4 justify-between rounded-full items-center my-1 border transition-all ${active === link.title ? "border border-blue text-blue" : "hover:border-blue border-transparent hover:text-blue"}`}
                ...
                <div className="flex-1 md:px-[5%] px-[3%]">
                    {
                        active === "General" ?
                        <div>
                            <h2 className="text-[25px] font-bold border border-transparent border-b-gray-100 dark:border-b-gray-900">General</h2>

                            <h3 className="py-2 text-[20px]">Appearance</h3>
                            <p>Choose between dark mode, light mode and default system settings</p>
                            
                            <div className="flex items-center justify-between dark:bg-gray-900 bg-gray-100 gap-3 p-2 my-6 rounded text-[12px] w-full">
                                <button className={`flex items-center justify-center gap-2 border border-gray-200 dark:border-gray-900 p-3 px-4 rounded w-[49%] ${theme === "System" ? "bg-blue text-white" : "dark:bg-black bg-white"}`} onClick={() => setTheme("System")}><PiDesktop className="text-[18px]"/> System</button>
                                <button className={`flex items-center justify-center gap-2 border border-gray-200 dark:border-gray-900 p-3 px-4 rounded w-[49%] ${theme === "Light" ? "bg-blue text-white" : "dark:bg-black bg-white"}`} onClick={() => setTheme("Light")}><PiSun className="text-[18px]" /> Light</button>
                                <button className={`flex items-center justify-center gap-2 border border-gray-200 dark:border-gray-900 p-3 px-4 rounded w-[49%] ${theme === "Dark" ? "bg-blue text-white" : "dark:bg-black bg-white"}`} onClick={() => setTheme("Dark")}><PiMoon className="text-[18px]" /> Dark</button>
                            </div>
                        </div>
                        : active === "Profile" ?
                        <div>
                        <h2 className="text-[25px] font-bold border border-transparent border-b-gray-100 dark:border-b-gray-900 mb-4">Profile</h2>
                            ...
                            <div className="flex items-center gap-3 my-6 rounded text-[12px] w-full">
                                <div className="w-[100px] h-[100px] dark:bg-gray-900 bg-gray-100 rounded-full"></div>
                                <div>
