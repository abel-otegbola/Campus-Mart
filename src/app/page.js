...
export default function Home() {
  ...
  return (
    <main className="">
      ...
      <header className="md:flex flex-col md:px-[8%] p-[3%] bg-gradient-to-tr from-blue/[0.07] to-white dark:to-black md:py-[3%] py-[20%] md:items-center items-start justify-between">
        <div className="md:w-auto w-full md:text-center">
          ...
          <p className="py-4">Discover, Trade, Connect: Your Campus, Your Marketplace!</p>
      ...
      <section className="grid lg:grid-cols-5 md:grid-cols-3 grid-cols-2 sm:gap-4 gap-2 md:px-[8%] sm:p-[3%] p-1">
        {
